...
{
    public class UnusedHomeController : Controller
    {
        private ISession _session { get; }
        public UnusedHomeController(ISession session)
        {
            _session = session;
        }
        ...
        public int  CreateTask()
        {
            ...
            var taskCreatedCommand = new Services.Commands.Task.CreateTaskCommand("gabi", "ado.net", "Learn parameter injection",
                null, 4);
